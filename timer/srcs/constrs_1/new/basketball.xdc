set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L12P_T1_MRCC_35 Sch=clk100mh
...
set_property -dict { PACKAGE_PIN T9   IOSTANDARD LVCMOS33 } [get_ports  { an[2] }]; #IO_L23N_T3_FWE_B_15 Sch=an[2]
